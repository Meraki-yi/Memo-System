...
const CATEGORY_GRADIENTS = [
    'linear-gradient(90deg, #667eea 0%, #764ba2 100%)',      // 工资 - 紫蓝渐变
    'linear-gradient(90deg, #f093fb 0%, #f5576c 100%)',      // 兼职 - 粉红渐变
    'linear-gradient(90deg, #4facfe 0%, #00f2fe 100%)',      // 理财 - 天蓝渐变
    'linear-gradient(90deg, #43e97b 0%, #38f9d7 100%)',      // 其他 - 青绿渐变
    'linear-gradient(90deg, #fa709a 0%, #fee140 100%)',      // 备用1 - 橙粉渐变
    'linear-gradient(90deg, #a8edea 0%, #fed6e3 100%)',      // 备用2 - 青粉渐变
    'linear-gradient(90deg, #ff9a9e 0%, #fecfef 100%)',      // 备用3 - 粉色渐变
    'linear-gradient(90deg, #ffecd2 0%, #fcb69f 100%)',      // 备用4 - 橙色渐变
];
